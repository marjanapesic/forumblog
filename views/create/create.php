    ...
    <div class="modal-content">
        ...
        <div class="modal-header">
            ...
            <h4 class="modal-title"
                id="myModalLabel"><?php echo Yii::t('ForumBlogModule.views_create_create', '<strong>Create</strong> new forum topic'); ?></h4>
        </div>
        ...
        <div class="modal-footer">
            ...
            <br/>
            <?php
            echo HHtml::ajaxButton(Yii::t('ForumBlogModule.views_create_create', 'Create'), array('//forumblog/create/create'), array(
                'type' => 'POST',
