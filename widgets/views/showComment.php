...
<div class="media" id="postComment_<?php echo $comment->id; ?>">
            ...
            <li class="dropdown ">
                ...
                <ul class="dropdown-menu pull-right">
                    ...
                    <?php if ($canWrite): ?>
                        <li>
                            <?php
                            echo HHtml::ajaxLink('<i class="fa fa-pencil"></i> '. Yii::t('CommentModule.widgets_views_showComment', 'Edit'), Yii::app()->createAbsoluteUrl('//forum/comment/edit', array('id' => $comment->id)), array(
                    ...
                    <?php if ($canDelete): ?>
                        <li>
                            ...
                            $this->widget('application.widgets.ModalConfirmWidget', array(
                                ...
                                'linkHref' => $this->createUrl("//forum/comment/delete", array('model' => 'ForumPost', 'id' => $comment->object_id, 'cid' => $comment->id)),
                                'confirmJS' => "function(html) { $('#comments_area_" . "ForumPost". "_" . $comment->object_id . "').html(html); }"
                            ));
                            ?>
                        </li>
                    <?php endif; ?>
    ...
    <div class="media-body">
        ...
        <div class="content" id="comment_editarea_<?php echo $comment->id; ?>">
            <span id="comment-message-<?php echo $comment->id; ?>"><?php print $comment->message; ?></span>
        ...
        <div class="wall-entry-controls">
            <?php Yii::app()->getController()->widget('application.modules.forum.widgets.LikeLinkWidget', array('object' => $comment)); ?>
        </div>
    </div>
    <hr>
</div>
