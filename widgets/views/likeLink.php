 ...
 */
?>
<a href="#" id="<?php echo $id . "-LikeLink"; ?>" class="like forumLikeAnchor"
   style="<?php if ($currentUserLiked): ?>display:none<?php endif; ?>"><?php echo Yii::t('LikeModule.widgets_views_likeLink', 'Like'); ?></a>
<a href="#" id="<?php echo $id . "-UnlikeLink"; ?>" class="unlike forumLikeAnchor"
...
<?php if (count($likes) > 0) { ?>
    ...
    <a href="<?php echo Yii::app()->createUrl('//forum/like/userlist', array('className' => $className, 'id' => $modelId)); ?>"
