            ...
            <ul class="nav nav-pills preferences">
                <li class="dropdown ">
                    ...
                    <ul class="dropdown-menu pull-right">
                        <?php $this->widget('application.modules.forum.widgets.ForumTopicEntryControls', array('object' => $post)); ?>
                    </ul>
                </li>
            </ul>
            ...
            <div class="media-body">
                ...
                <h4 class="media-heading"><a
                    ...
                    <small><?php echo HHtml::timeago($post->content->created_at); ?>
                        ...
                        <!-- show labels -->
                        <?php //$this->widget('application.modules_core.wall.widgets.WallEntryLabelWidget', array('object' => $post)); ?>
